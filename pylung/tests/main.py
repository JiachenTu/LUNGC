...
DATA_PATH = '/media/data/vaishnavi/LIDC-IDRI/images/LIDC-IDRI-0001/'
# DATA_PATH = '../data/testdir/'
OUT_PATH = '/home/jtu9/lung/TF_Object_Detection_API/LIDC/output/'


def build_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument('mode', type = str, default = 'view', help='the mode(data cut or view ?)',nargs='?')
    parser.add_argument('-m', '--method', type=str, default='original', help='the cut or view method',nargs='?')
    parser.add_argument('-s', '--srcpath', type=str, default=DATA_PATH, help='the dcm image path',nargs='?')
    parser.add_argument('-d', '--dstpath', type=str, default=OUT_PATH, help='the output path',nargs='?')
    return parser
